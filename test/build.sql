...
ALTER TABLE partsupp ADD CONSTRAINT pk_partsupp_1 PRIMARY KEY (PS_PARTKEY, PS_SUPPKEY);
...
ALTER TABLE lineitem ADD CONSTRAINT pk_lineitem_1 PRIMARY KEY (L_ORDERKEY, L_LINENUMBER);
...
ALTER TABLE ORDERS CONSTRAINT fk_orders_1 ADD FOREIGN KEY (O_CUSTKEY) REFERENCES CUSTOMER(C_CUSTKEY);
